...
params:
  dat.folder: "C:/Users/Julian/Google Drive/manuscripts/StovitzShrier - ACLS/data/"
...
####### Read in the data ###########
acls <- read.csv(paste0(dat.base, params$file.name))
...
save(PA.results, PA.results.m, PA.results.f, CRF.results, CRF.results.m, CRF.results.f,
     file = paste0(code.base, "mediation-results.Robj")) ## Save the results
